...
type ClusterTimeNDistanceResponse struct{

	// Agent ID
	//
	AgentID string `json:"agentid"`

	//Time to complete cluster
	ClusterTime int64 `json:"clusterTime"`

	//Distance covered by cluster
	ClusterDistance int64 `json:"clusterDistance"`
...
type GoogleDirectionAPIStruct struct {
	Routes []struct {
		Legs []struct {
			Distance struct {
				Text  string `json:"text"`
